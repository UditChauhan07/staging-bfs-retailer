...
//   const [box, setBox] = useState({ RETAILERS: 0, GROWTH: 0, ORDERS: 0, REVENUE: 0 })
...
//   const [monthBrandData, setMonthBrandData] = useState({ isLoaded: false, data: [] });
...
//             setBox({ RETAILERS: dashboard?.activeAccount || 0, GROWTH: 0, ORDERS: dashboard?.totalOrder || 0, REVENUE: dashboard?.totalPrice || 0 })
...
//               });
//             }
//             // console.log({aa:dashboard.setMonthlydata});
//             // setMonthlydata
...
//   };
//   useEffect(() => {
//     setTargetValue(Number(Monthlydataa?.data?.filter((ele) => ele.salesRepId === salesRepId)[0]?.total?.target / 1000).toFixed(0));
//     setAchievedSales(Number(Monthlydataa?.data?.filter((ele) => ele.salesRepId === salesRepId)[0]?.total?.sale / 1000).toFixed(0));
//   }, [Monthlydataa]);
//   useEffect(() => {
//     setNeedle_data([
