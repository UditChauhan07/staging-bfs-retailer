          ...
          <div>
            <div className="col-12 p-0">
              {isLoading ? (
                ...
                <div>
                  <div className="uppercase text-center flex justify-center items-center tracking-[1.8px] my-[48px]" style={{ fontFamily: "Montserrat-500" }}>
                    ...
                    {filteredPageData?.length ? (
                      <>
                        {filteredPageData?.map((brand, index) => (
                          <BrandCard key={index} image={brandsImageMap[brand?.Name] || defaultImage} brand={brand} />
                        ))}
                      </>
                    ) : null}
                  </div>
