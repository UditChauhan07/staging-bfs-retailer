...
export const SignUpFormSchema = Yup.object().shape({
    firstName: Yup.string().required("This field is required.").min(2, "Use 2 or more characters for Name").max(20, "Use 20 characters or fewer for your Name"),lastName: Yup.string().required("This field is required.").min(1, "Use 1 or more characters for Name").max(20, "Use 20 characters or fewer for your Name"),
    ...
    brands: Yup.array().min(1, "Pick at least 1 hobby").required("This field is required"),
